...
dc.data %>% ggplot() +
  geom_line(aes(x = xxx), stat = "count", group = 1, color = "blue", size = 1) +
  ...
  scale_y_continuous(limits = c(0, xxxx), breaks = c(0, 5000,10000,15000,20000,25000,30000,35000), labels = c(0,5,10,15,20,25,30,35))
