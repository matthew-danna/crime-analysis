...
# Step 2
dc.data.temp <- rbind(dc.data2024, dc.data2023, dc.data2022,
                      dc.data2021, dc.data2020, dc.data2019,
                      dc.data2018, dc.data2017, dc.data2016,
                      dc.data2015, dc.data2014, dc.data2013,
                      dc.data2012, dc.data2011, dc.data2010)
...
graph + labs(
  title = "Crime per Shift by Offense",
  x = "Shift",
  y = "Crime Count"
) +
  theme(
